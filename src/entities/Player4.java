...
public class Player4 extends PlayableCharacter {
    ...
    private static final double CD_WIDTH = GameConstants.CD_WIDTH;
    private static final double CD_HEIGHT = GameConstants.CD_HEIGHT;
    private static final String IMAGE_PATH = null;

    public Player4(double startX, double startY) {
        super(startX, startY, CD_WIDTH, CD_HEIGHT);

        this.maxHp += GameConstants.CD_HP_BONUS;
        this.currentHp = this.maxHp;
        this.speed *= GameConstants.CD_SPEED_MULTIPLIER;
